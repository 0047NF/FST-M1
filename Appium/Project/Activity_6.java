...
public class Activity_6 {
	...
	public void validLoginTest() {
		...
		wait.until(
				ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//android.widget.TextView[@text='Popups']")));

		driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text='Popups']")).click();

		wait.until(ExpectedConditions
				.visibilityOfElementLocated(AppiumBy.xpath("//android.widget.Button[@text='Sign In']")));
		...
		driver.findElement(AppiumBy.xpath("//android.widget.EditText[@resource-id='password']")).click();
